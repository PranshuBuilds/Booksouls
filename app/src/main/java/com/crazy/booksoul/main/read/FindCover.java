...
public class FindCover {
    ...
    public Bitmap FindCoverItself(String srcDir) throws IOException {
        ...
        while (entries.hasMoreElements()) {
            ZipEntry zipEntry = entries.nextElement();
            CharSequence[] charSequence = {"cover.jpg", "cover.JPG", "cover.jpeg", "cover.JPEG", "cover.png", "cover.PNG", "Covers.jpg", "Cover.JPG", "Cover.jpeg", "Cover.JPEG", "Cover.png", "Cover.PNG"};
            for (int i = 0; i < charSequence.length; i++) {
