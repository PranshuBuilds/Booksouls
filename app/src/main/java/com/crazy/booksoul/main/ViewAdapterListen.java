...
public class ViewAdapterListen extends FragmentPagerAdapter {

    public static String str;
    Context context;
    public ViewAdapterListen(FragmentManager fm , Context context) {
        super(fm);
...
//        String settitle1 = context.getResources().getString(R.string.tab_article);
        ...
        String tabtitles[] = new String[] {settitle2 , settitle3,settitle4};
