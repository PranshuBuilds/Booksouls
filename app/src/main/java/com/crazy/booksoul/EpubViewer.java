...
import com.crazy.booksoul.main.read.CustomWebView;
import com.crazy.booksoul.main.read.RefreshEpub;
import com.crazy.booksoul.main.read.SaveQuote;
import com.crazy.booksoul.main.read.UnzipEpub;
...
//    NavigationView navigationViewQuote;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(R.color.trNAPrent);
        toolbar.setBackgroundResource(R.drawable.filled_border3);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                InjectCss(view, "img { display: block !important; width: 90% !important; height: auto !important; }");
...
//                            textViewPage.setText(pageNumber);
                            if (!seeking) {
                                if (url.contains("#")) {
